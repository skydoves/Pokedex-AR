...
class GVAdapter(val context: Context?, var pokemonList: List<Pokemon>) :BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        val resourceId = context.resources.getIdentifier(pokemon.image, "drawable", context.packageName)
